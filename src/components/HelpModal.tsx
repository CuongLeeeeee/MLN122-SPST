      ...
      <div className={styles.panel}>
        ...
        <div style={{ display: "grid", gap: 10, lineHeight: 1.5 }}>
          <div>
            ...
            đã vượt qua (chỉ quay lại, không có nút nhảy lên màn sau).
          </div>

          <div>
            Phím: <span className={styles.kbd}>WASD</span> /{" "}
            <span className={styles.kbd}>←↑→↓</span>, tương tác{" "}
            <span className={styles.kbd}>E</span>, pause{" "}
            <span className={styles.kbd}>Esc</span>.
          </div>

          <div className={styles.muted}>
            Mẹo: Âm thanh (SFX) chỉ hoạt động sau khi bạn bấm Start
            (AudioContext chỉ tạo sau thao tác của bạn).
          </div>
        </div>
      </div>
    </div>
